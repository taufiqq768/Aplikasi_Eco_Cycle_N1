    ...
    @if ($isAllowed)
        <form wire:submit='submit' class="form" enctype="multipart/form-data" wire:key='{{ rand() }}'>
            <div class="row mt-4">
                ...
                <div class="col-6 mt-3">
                    <label for="produksi_limbahserum">Produksi Limbah Serum (Kg)</label>
                    <input type="text" name="produksi_limbahserum" id="produksi_limbahserum"
                        class="form-control form-control-lg" value="@thousands($produksi_limbahserum)" readonly>
                </div>
                ...
                @else
                    @if ($id_data_limbahserum)
                        <div class="d-flex justify-content-start mt-2">
                            <img src="{{ asset('storage/' . $dataLimbahserum->nama_file) }}" alt="Preview Gambar"
                                style="max-height: 300px; max-width: 300px;">
                        </div>
                    @endif
                @endif
