                ...
                <div class="card-body position-relative">
                    <div class="row align-items-center">
                        <div class="col-8 col-lg-7">
                            <h4 class="fs-16 mb-1">Abu Janjang</h4>
                            <p class="text-muted mb-0" id="tanggal">Produksi Abu Janjang s.d
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableAbuJanjang"
                                    ...
                                    <thead>
                                        <tr class="text-center align-middle">
                                            ...
                                            <th class="bg-primary-subtle" rowspan="2">Tankos Dibakar</th>
                                            <th class="bg-primary-subtle" rowspan="2">Produksi Abu Janjang</th>
                                            <th class="bg-primary-subtle" rowspan="2">% Produksi Abu Janjang dari
                                                Tankos
                                                Dibakar
                                            </th>
                                            <th class="bg-primary-subtle" rowspan="2">Digunakan sbg Pupuk Organik
                                            </th>
                                            <th class="bg-primary-subtle" rowspan="2">Sisa Abu Janjang</th>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableAbuJanjangBi"
                                    style="border: 0.5px solid rgba(128, 128, 128, 0.3); margin-bottom: 0px !important;">
                                    <thead>
                                        <tr class="text-center align-middle">
                                            <th class="bg-primary-subtle text-center" rowspan="2">Region</th>
...
@push('js')
    ...
    <script>
        ...
        $("#datepicker-1").datepicker({
            ...
            bulan = month;
            tahun = year;
            $('#tanggal').text('Produksi Abu Janjang s.d ' + namaBulan[bulan] + " " + tahun);
            $('.tanggal2').text('Sampai Dengan Bulan ' + namaBulan[bulan] + " " + tahun);
            updateChartData(bulan, tahun, 'abu_janjang');
        });
        updateChartData({{ $bulan }}, {{ $tahun }}, 'abu_janjang');
