                ...
                <div class="card-body position-relative">
                    <div class="row align-items-center">
                        <div class="col-8 col-lg-7">
                            <h4 class="fs-16 mb-1">Cangkang</h4>
                            <p class="text-muted mb-0" id="tanggal">Produksi Cangkang s.d
                        ...
                        <div class="col-4 col-lg-5 position-relative d-sm-block d-none">
                            <img src="{{ asset('assets/images/3d assets/cangkang.png') }}" alt=""
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableCangkang"
                                    ...
                                    <thead>
                                        <tr class="text-center align-middle">
                                            ...
                                            <th class="bg-primary-subtle text-center" rowspan="2">PKS</th>
                                            <th class="bg-primary-subtle" rowspan="2">TBS Olah</th>
                                            <th class="bg-primary-subtle" rowspan="2">Produksi Cangkang</th>
                                            <th class="bg-primary-subtle" rowspan="2">% Produksi<br>dr TBS Olah
                                            </th>
                                            <th class="bg-primary-subtle" rowspan="2">Digunakan untuk bahan bakar
                                                PKS</th>
                                            <th class="bg-primary-subtle" rowspan="2">Sisa</th>
                                            <th class="bg-primary-subtle" rowspan="2">Sisa Akhir</th>
                                            <th class="bg-primary-subtle" colspan="5">Dikirim Ke</th>
                                            ...
                                            <th class="bg-primary-subtle" rowspan="2">Diterima Dari PKS Lain</th>
                                            <th class="bg-primary-subtle" rowspan="2">% Ekses Cangkang</th>
                                            <th class="bg-primary-subtle" rowspan="2">% Ekses Cangkang (Material
                                                Balance)
                                            </th>
                                        </tr>
                                        <tr class="text-center align-middle">
                                            <th class="bg-primary-subtle">Pabrik Teh</th>
                                            <th class="bg-primary-subtle">Pabrik Karet</th>
                                            <th class="bg-primary-subtle">Pabrik Gula</th>
                                            <th class="bg-primary-subtle">Bibitan Kelapa Sawit</th>
                                            <th class="bg-primary-subtle">PKS Lain</th>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableCangkangBi"
                                    style="border: 0.5px solid rgba(128, 128, 128, 0.3); margin-bottom: 0px !important;">
                                    <thead>
                                        <tr class="text-center align-middle">
                                            <th class="bg-primary-subtle text-center" rowspan="2">Region</th>
...
@push('js')
    ...
    <script>
        ...
        $("#datepicker-1").datepicker({
            ...
            bulan = month;
            tahun = year;
            $('#tanggal').text('Produksi Cangkang s.d ' + namaBulan[bulan] + " " + tahun);
            $('.tanggal2').text('Sampai Dengan Bulan ' + namaBulan[bulan] + " " + tahun);
            updateChartData(bulan, tahun, 'cangkang');
            // $('#tableCangkang').DataTable().ajax.url('/api/data-item-detail' + bulan + '/' + tahun + "/cangkang")
            //     .load();
        });
        updateChartData({{ $bulan }}, {{ $tahun }}, 'cangkang');
