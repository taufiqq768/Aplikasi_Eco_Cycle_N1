                ...
                <div class="card-body position-relative">
                    <div class="row align-items-center">
                        <div class="col-8 col-lg-7">
                            <h4 class="fs-16 mb-1">Fiber</h4>
                            <p class="text-muted mb-0" id="tanggal">Produksi Fiber s.d
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableFiber"
                                    ...
                                    <thead>
                                        <tr class="text-center align-middle">
                                            ...
                                            <th class="bg-primary-subtle" rowspan="2">Produksi Fiber</th>
                                            ...
                                            <th class="bg-primary-subtle" rowspan="2">% Ekses Fiber</th>
                                            <th class="bg-primary-subtle" rowspan="2">% Ekses Fiber (Material
                                                Balance)
                                            </th>
                                        </tr>
                                        <tr class="text-center align-middle">
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableFiberBi"
                                    style="border: 0.5px solid rgba(128, 128, 128, 0.3); margin-bottom: 0px !important;">
                                    <thead>
                                        <tr class="text-center align-middle">
                                            <th class="bg-primary-subtle text-center" rowspan="2">Region</th>
...
@push('js')
    ...
    <script>
        ...
        $("#datepicker-1").datepicker({
            ...
            bulan = month;
            tahun = year;
            $('#tanggal').text('Produksi Fiber s.d ' + namaBulan[bulan] + " " + tahun);
            $('#tanggal2').text('Sampai Dengan Bulan ' + namaBulan[bulan] + " " + tahun);
            updateChartData(bulan, tahun, 'fiber');
        });
        updateChartData({{ $bulan }}, {{ $tahun }}, 'fiber');
