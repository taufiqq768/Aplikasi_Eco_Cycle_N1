                ...
                <div class="card-body position-relative">
                    <div class="row align-items-center">
                        <div class="col-8 col-lg-7">
                            <h4 class="fs-16 mb-1">Tankos</h4>
                            <p class="text-muted mb-0" id="tanggal">Produksi Tankos s.d
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableTankos"
                                    ...
                                    <thead>
                                        <tr class="text-center align-middle">
                                            ...
                                            <th class="bg-primary-subtle" rowspan="2">Produksi Tankos</th>
                                            <th class="bg-primary-subtle" rowspan="2">% Produksi<br>dr TBS Olah
                                            </th>
                                            <th class="bg-primary-subtle" rowspan="2">Digunakan Sebagai Pupuk
                                                Organik Kebun
                                                Sendiri</th>
                                            <th class="bg-primary-subtle" rowspan="2">Digunakan untuk PLTBm</th>
                                            <th class="bg-primary-subtle" rowspan="2">Dikembalikan ke Pemasok</th>
                                            <th class="bg-primary-subtle" rowspan="2">Sisa Tankos</th>
                                            <th class="bg-primary-subtle" rowspan="2">Dibakar di Tungku Bakar</th>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableTankosBi"
                                    style="border: 0.5px solid rgba(128, 128, 128, 0.3); margin-bottom: 0px !important;">
                                    <thead>
                                        <tr class="text-center align-middle">
                                            <th class="bg-primary-subtle text-center" rowspan="2">Region</th>
...
@push('js')
    ...
    <script>
        ...
        $("#datepicker-1").datepicker({
            ...
            bulan = month;
            tahun = year;
            $('#tanggal').text('Produksi Tankos s.d ' + namaBulan[bulan] + " " + tahun);
            $('.tanggal2').text('Sampai Dengan Bulan ' + namaBulan[bulan] + " " + tahun);
            updateChartData(bulan, tahun, 'tankos');
        });
        updateChartData({{ $bulan }}, {{ $tahun }}, 'tankos');
