    ...
    @if ($isAllowed)
        <form wire:submit='submit' class="form" enctype="multipart/form-data" wire:key='{{ rand() }}'>
            <div class="row mt-4">
                ...
                <div class="col-6 mt-3">
                    <label for="produksi_abu_boiler">Produksi Abu Boiler (Kg)</label>
                    <input type="text" name="produksi_abu_boiler" id="produksi_abu_boiler"
                        class="form-control form-control-lg" value="@thousands($produksi_abu_boiler)" readonly>
                </div>
                ...
                <div class="col-6">
                    <div class="col-12 mt-3" x-data="{ value: @entangle('volume_keperluan_lain') }">
                ...
                @else
                    @if ($id_data_abu_boiler)
                        <div class="d-flex justify-content-start mt-2">
                            <img src="{{ asset('storage/' . $dataAbuBoiler->nama_file) }}" alt="Preview Gambar"
                                style="max-height: 300px; max-width: 300px;">
                        </div>
                    @endif
                @endif
