                ...
                <div class="card-body position-relative">
                    <div class="row align-items-center">
                        <div class="col-8 col-lg-7">
                            <h4 class="fs-16 mb-1">Pome</h4>
                            <p class="text-muted mb-0" id="tanggal">Produksi Pome s.d
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                <table class="table table-hover table-bordered mb-0" id="tablePome"
                                    style="border: 0.5px solid rgba(128, 128, 128, 0.3); margin-bottom: 0px !important;">
                                    <thead>
                                        <tr class="text-center align-middle">
                                            <th class="bg-primary-subtle text-center">Region</th>
                                            ...
                                            <th class="bg-primary-subtle">% Produksi<br>dr TBS Olah</th>
                                            <th class="bg-primary-subtle">Digunakan utk Biogas PKS</th>
                                            ...
                                            <th class="bg-primary-subtle">POME Oil Terkutip Dikirim ke PKS Lain</th>
                                            <th class="bg-primary-subtle">Dijual</th>
                                            <th class="bg-primary-subtle">Harga Jual Rata-rata</th>
                                            <th class="bg-primary-subtle">Pendapatan</th>
                                            <th class="bg-primary-subtle">Stok Awal Tahun</th>
                                            <th class="bg-primary-subtle">Sisa Stok Akhir</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                ...
                <div class="tab-pane fade" id="nav2-profile" role="tabpanel" aria-labelledby="#nav2-profile-tab">
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                <table class="table table-hover table-bordered mb-0" id="tablePomeBi"
                                    style="border: 0.5px solid rgba(128, 128, 128, 0.3); margin-bottom: 0px !important;">
                                    <thead>
                                        <tr class="text-center align-middle">
                                            <th class="bg-primary-subtle text-center">Region</th>
...
@push('js')
    ...
    <script>
        ...
        $("#datepicker-1").datepicker({
            ...
            bulan = month;
            tahun = year;
            $('#tanggal').text('Produksi Pome s.d ' + namaBulan[bulan] + " " + tahun);
            $('.tanggal2').text('Sampai Dengan Bulan ' + namaBulan[bulan] + " " + tahun);
            updateChartData(bulan, tahun, 'pome');
        });
        updateChartData({{ $bulan }}, {{ $tahun }}, 'pome');
