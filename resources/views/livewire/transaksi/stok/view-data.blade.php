                            ...
                            <table class="table table-hover table-bordered" id="tableStok">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th class="bg-light">Cangkang</th>
                                        <th class="bg-light">Fiber</th>
                                        <th class="bg-light">Tankos</th>
                                        <th class="bg-light">Abu Janjang</th>
                                        <th class="bg-light">Solid</th>
                                        <th class="bg-light">Pome Oil</th>
                                        <th class="bg-light">PKM</th>
...
@push('js')
    <livewire:transaksi.stok.modal-create />
    <script>
