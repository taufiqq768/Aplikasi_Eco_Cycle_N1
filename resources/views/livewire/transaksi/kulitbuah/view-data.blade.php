                ...
                <div class="card-body position-relative">
                    <div class="row align-items-center">
                        <div class="col-8 col-lg-7">
                            <h4 class="fs-16 mb-1">Kulit Buah</h4>
                            <p class="text-muted mb-0" id="tanggal">Produksi Kulit Buah s.d
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0" id="tableKulitbuah"
                                    ...
                                    <thead>
                                        <tr class="text-center align-middle">
                                            ...
                                            <th class="bg-primary-subtle" rowspan="2">Produksi Kopi diolah</th>
                                            <th class="bg-primary-subtle" rowspan="2">Produksi Kulit Buah</th>
                                            ...
                                            <th class="bg-primary-subtle" rowspan="2">Sisa Kulit Buah</th>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body" wire:ignore>
                                ...
                                <table class="table table-hover table-bordered mb-0 w-100" id="tableKulitbuahBi"
                                    style="border: 0.5px solid rgba(128, 128, 128, 0.3); margin-bottom: 0px !important; ">
                                    <thead>
                                        <tr class="text-center align-middle">
                                            <th class="bg-primary-subtle text-center" rowspan="2">Region</th>
...
@push('js')
    ...
    <script>
        ...
        $("#datepicker-1").datepicker({
            ...
            bulan = month;
            tahun = year;
            $('#tanggal').text('Produksi Kulit Buah s.d ' + namaBulan[bulan] + " " + tahun);
            $('.tanggal2').text('Sampai Dengan Bulan ' + namaBulan[bulan] + " " + tahun);
            updateChartDataN1(bulan, tahun, 'kulit_buah');
        });
        updateChartDataN1({{ $bulan }}, {{ $tahun }}, 'kulit_buah');
