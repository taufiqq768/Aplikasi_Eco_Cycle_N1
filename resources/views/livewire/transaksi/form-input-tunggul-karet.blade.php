    ...
    <form wire:submit='submit' class="form" enctype="multipart/form-data" wire:key='{{ rand() }}'>
            <div class="row mt-4">
                <div class="col-6 mt-3">
                    <label for="tbs_olah">Produksi Karet diolah (Kg)</label>
                    <input type="text" name="tbs_olah" id="tbs_olah" class="form-control form-control-lg"
                        value="@thousands($tbs_olah)" readonly>
                </div>
                <div class="col-6 mt-3">
                    <label for="produksi_tunggulkaret">Produksi Tunggul Karet (Kg)</label>
                    <input type="text" name="produksi_tunggulkaret" id="produksi_tunggulkaret"
                        class="form-control form-control-lg" value="@thousands($produksi_tunggulkaret)" readonly>
                </div>
                ...
                @else
                    @if ($id_data_tunggulkaret)
                        <div class="d-flex justify-content-start mt-2">
                            <img src="{{ asset('storage/' . $dataTunggulkaret>nama_file) }}" alt="Preview Gambar"
                                style="max-height: 300px; max-width: 300px;">
                        </div>
                    @endif
                @endif
