...
<div class="modal fade" id="modalCreateHargaN1" wire:ignore.self>
            ...
            <form wire:submit='save'>
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="" id="bulan" wire:model='bulanSelected' class="form-control" required>
                            <option value=""></option>
                            @foreach ($rentangBulan as $bulan)
...
@push('js')
    <script>
        function setDataModal(tahun, bulan, kategori, harga) {
            $('#modalCreateHargaN1').modal('show');
        }
    </script>
@endpush
