        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h5 class="my-2">Manajemen Harga Standart Waste PTPN 1</h5>
                </div>
                <div class="card-body">
                    <div class="d-flex mb-3 justify-content-end">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalCreateHargaN1">+
                            Tambah
                            Data</button>
                    </div>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning"
                                                @click="editData('{{ $harga->tahun }}', '{{ $harga->bulan }}', '{{ $harga->kategori }}', '{{ $harga->harga_per_kg }}')">Edit</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
@push('js')
    <livewire:master.modal.modal-create-master-harga-n1 />
    <script>
