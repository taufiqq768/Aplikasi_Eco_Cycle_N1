...
class MonitoringPengisian extends Component
{
    public $bulan;
    public $tahun;
    ...
    public function render()
    {
        if (Auth::user()->role == 'ADMIN_REGIONAL' || Auth::user()->role == 'VIEWER_REGIONAL') {
            ...
            $data = MasterRegion::withMonitoring($this->bulan, $this->tahun)
        ...
        return view('livewire.monitoring.monitoring-pengisian', compact('data'));
    }
